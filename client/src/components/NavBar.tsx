  ...
  const closeWheelsPopup = () => {
    ...
    selectedWheel &&
      ...
      dispatch(
        setWheelSnapshot({
          inputNumbers:
            selectedWheel.name === "yes-no-wheel"
    ...
    <nav className="bg-white px-6 lg:px-10 sticky top-0 shadow-lg z-[999]">
      <div className="navbar max-w-[1360px] mx-auto">
        <div className="navbar-start w-auto">
          <div
            className="btn btn-ghost text-xl flex p-0 gap-0 !h-auto"
            onClick={() => navigate("/")}
          >
            <img
        ...
        {!isPublic && (
          <>
            ...
            <div className="navbar-end flex-1 md:hidden">
              <div
                ref={dropdownRef}
                className="relative dropdown dropdown-left dropdown-bottom"
              >
                <button
                  ...
                  <ul className="menu menu-xs absolute mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 left-[-180px]">
                    {menuItems?.map((item) => (
                      <MenuItem
                        ...
                        setActiveModal={() => {
                          setIsDropdownOpen(false);
                          dispatch(setActiveModal(item.value));
                        }}
                ...
                {isWheelsPopupOpen && (
                  <WheelsPopup onClose={closeWheelsPopup} />
                )}
              </div>
              <ul>

  ...
  return (
    <div className="bg-slate p-8 font-sans">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="mb-6">
          Welcome to <strong className="text-blue">TheSpinnerWheel.com</strong>{" "}
        ...
        <p className="mb-6">
          ...
          <strong className="text-blue">TheSpinnerWheel.com</strong> comes in.
        ...
        <p className="mb-6">
          <strong className="text-blue">TheSpinnerWheel.com</strong> provides a
          variety of interactive tools designed to suit your diverse needs:
        </p>
        <ul className="list-disc pl-6 mb-6 space-y-2">
          <li>
            <strong className="text-blue">Customizable Spinner Wheels:</strong>{" "}
            Create your own wheels by adding personalized options. Perfect for
            games, raffles, or settling friendly debates.
          </li>
          <li>
            <strong className="text-blue">Yes/No Picker Wheel:</strong> Simplify
            decisions with a straightforward yes or no answer.
          </li>
          <li>
            <strong className="text-blue">Number Picker Wheel:</strong> Generate
            random numbers within a range you set, ideal for lotteries or
            educational purposes.
          </li>
          <li>
            <strong className="text-blue">Letter Picker Wheel:</strong> Pick
        ...
        <p className="mb-6">
          ...
          <strong className="text-blue">TheSpinnerWheel.com</strong> and make it
        ...
        <p className="mb-6">
          ...
          <strong className="text-blue">TheSpinnerWheel.com</strong> better.
        ...
        <p className="mb-6">
          ...
          hope <strong className="text-blue">TheSpinnerWheel.com</strong>{" "}
        ...
        <p className="mt-8">
          ...
          <strong className="text-blue">TheSpinnerWheel.com</strong>!
        </p>
      </div>
    </div>
  );

    ...
    <div className="bg-slate p-8 font-sans">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="mb-6 text-black">
          At <strong>TheSpinnerWheel.com</strong>, we value your privacy and are
          committed to protecting your personal information. This Privacy Policy
          outlines how we collect, use, and safeguard your data when you visit
          our website. By accessing or using our services, you agree to the
        ...
        <p className="mb-6 text-black">
          ...
          information that you voluntarily provide to us when you interact with
          our website. This includes your name, email address, and any other
          details you submit through contact forms, newsletter sign-ups, or
        ...
        <p className="mb-6 text-black">
          ...
          patterns. This may include your IP address, browser type, pages
          visited, time spent on pages, and other diagnostic data. This
        ...
        <p className="mb-6 text-black">
          ...
          website. Cookies are small data files stored on your device that help
          us remember your preferences, customize content, and analyze website
          traffic. You can instruct your browser to refuse all cookies or
        ...
        <ul className="list-disc pl-6 mb-6 space-y-2 text-black">
          <li>
            To Provide and Maintain Our Service: Ensuring our website functions
        ...
        <p className="mb-6 text-black">
          ...
          have no control over the content and practices of these websites and
          cannot accept responsibility for their respective privacy policies. We
        ...
        <p className="mb-6 text-black">
          ...
          reasons. Any modifications will be posted on this page with an updated
          revision date.
        </p>
        ...
        <p className="mt-8 text-black">
          ...
          at support@thespinnerwheel.com.
        </p>
      </div>
    </div>
  );
